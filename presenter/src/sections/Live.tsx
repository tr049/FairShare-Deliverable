      ...
      <div className="mt-8 grid grid-cols-1 lg:grid-cols-[340px_1fr] gap-6">
        ...
        <div className="min-h-[600px]">
          <AnimatePresence mode="wait">
            ...
            ) : activePhase?.key === "security" ? (
              <SecurityPlaceholder key="security" message={status.message} />
...
function SecurityPlaceholder({ message }: { message?: string }) {
  return (
    <Card className="h-full p-8" elevated>
      <CardHeader className="px-0 pt-0">
        ...
        <CardDescription>
          {message ??
            "A white-hat penetration test of the live build, after QA — authentication, authorization, injection, validation, and misconfiguration. Findings land in the terminal and in security/security-report.md."}
        </CardDescription>
      </CardHeader>
      <CardContent className="px-0 pb-0 mt-2 space-y-3">
        <div className="h-4 w-2/3 rounded shimmer" />
